...
_whitelist_expiry_
Whitelist entries in _/etc/nftfw/whitelist.d_ are automatically expired by the number of days in this variable. **Nftfw** computes the delay as the difference between 'now' and the time on the file.
...
**nft(1)**, **nftfwls(1)**,  **nftfwedit(1)**, **nftnetchk(1)**, **nftfwan(1)**, **nftfwadm(1)**, **nftfw-files(5)**
